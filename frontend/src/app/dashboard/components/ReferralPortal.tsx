    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
      ...
      <Card className="bg-black/40 border-white/10 rounded-none h-[220px] shadow-2xl relative overflow-hidden flex flex-col">
        ...
        <div className="px-8 pt-8 pb-4 border-b border-white/5 flex justify-between items-center bg-zinc-900/40">
          ...
          <span className="text-[8px] font-mono text-white/40 tracking-tighter">STATUS: ARMED</span>
        </div>
        <CardContent className="flex-grow p-8 flex flex-col justify-center gap-6">
          <div className="flex flex-col gap-2">
            <span className="text-[9px] font-mono text-white/20 uppercase tracking-widest mb-1 font-bold">Enter Referral ID:</span>
            <div className="flex gap-2 h-14">
              <Input 
                ...
                maxLength={6}
                placeholder="000000"
                className="bg-white/5 border-white/10 rounded-none h-full font-mono text-lg tracking-[0.5em] text-center focus:border-cyan-accent focus:ring-0 uppercase placeholder:text-white/5 placeholder:tracking-normal"
              />
              <button 
                onClick={onRedeem}
                disabled={isRedeeming || referralInput.length !== 6}
                className="px-6 h-full bg-cyan-accent text-black font-heading text-[10px] tracking-widest hover:bg-white transition-all disabled:opacity-30 disabled:hover:bg-cyan-accent disabled:cursor-not-allowed uppercase"
              >
